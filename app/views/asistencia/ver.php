                    ...
                    <tr>
                        ...
                        <td data-label="Empleado">
                            <div class="empleado-info">
                                ...
                                <span><?php echo htmlspecialchars(stripslashes($emp['nombre'] . ' ' . $emp['apellido'])); ?></span>
                            </div>
                        </td>
                        <td data-label="DNI"><?php echo $emp['dni']; ?></td>
                        <td data-label="Cargo">
                            <span
                                class="badge badge-cargo"><?php echo htmlspecialchars($emp['nombre_cargo'], ENT_QUOTES, 'UTF-8'); ?></span>
                        </td>
                        <td data-label="Turno">
                            <span
                                class="badge badge-turno"><?php echo htmlspecialchars($emp['nombre_turno'], ENT_QUOTES, 'UTF-8'); ?></span>
                        </td>
                        ...
                        <td data-label="Justificacion">
                            <?php if ($emp['justificado'] == 1): ?>
                                <button class="btn-ver-justificacion"
                                    onclick="verJustificacion(<?php echo $emp['id_empleado']; ?>, '<?php echo date('Y-m-d'); ?>')">
                                    <i class="fas fa-eye"></i> Ver justificación
                                </button>
                            <?php else: ?>
                                <button class="btn-justificar"
                                    onclick="justificarFalta(<?php echo $emp['id_empleado']; ?>, '<?php echo date('Y-m-d'); ?>', this)">
