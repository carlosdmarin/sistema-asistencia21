        ...
        <?php else: ?>
            <div class="table-wrapper">
                <table class="table-responsive-table">
                    ...
                    <tbody>
                        <?php foreach ($cargos as $caguito): ?>
                        <tr>
                            <td data-label="ID"><?php echo $caguito['id_cargo']; ?></td>
                            <td><?php echo htmlspecialchars($caguito['nombre_cargo']); ?></td>
                                <td data-label="Acciones">
                                <div class="acciones">
                                    <a href="<?php echo BASE_URL; ?>/cargo/editar/<?php echo $caguito['id_cargp'] ?>" 
                                       class="btn-accion btn-editar" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button onclick="confirmarEliminar(<?php echo $caguito['id_cargo']; ?>, '<?php echo htmlspecialchars($caguito['nombre_cargo']); ?>')" 
